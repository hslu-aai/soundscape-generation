...
class CityscapesDataset:
    def __init__(self):
        ...
        self.val_segmentation_paths = sorted(
            glob.glob(os.path.join(os.getcwd(), 'data', 'segmentations', 'val', '*', '*labelIds.png')))
        ...
        self.class_weights = [2.602, 6.707, 3.522, 9.877, 9.685, 9.398, 10.288, 9.969,
                              ...
                              10.264, 10.394, 10.094,
                              0.0]  # class 'other' has weight 0 in order to disregard its pixels
    ...
    def get_training_batch(self, batch_id, batch_size, image_size):
        ...
        batch_segmentations = [read_segmentation(self.segmentation_paths[i], image_size, self.id2label) for i in
